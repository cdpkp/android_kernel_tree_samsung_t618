...
*****************************************************************************/
/*Tab A8 code for SR-AX6300-01-449 by yuli at 2021/11/19 start*/
#define FTS_FW_REQUEST_SUPPORT                      1
/*Tab A8 code for SR-AX6300-01-449 by yuli at 2021/11/19 end*/
...
struct upgrade_module focal_module_list[] = {
...
static int fts_fw_write_start(const u8 *buf, u32 len, bool need_reset)
{
    ...
    upg->ts_data->fw_loaded_ok = false;
...
{
    int i = 0;
    struct upgrade_module *info = &focal_module_list[0];
